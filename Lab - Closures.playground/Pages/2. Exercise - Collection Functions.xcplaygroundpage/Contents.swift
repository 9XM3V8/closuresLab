...
var names = ["Dylan", "Emily", "Madden", "Will", "Jordan", "Dawson", "Kaden", "Wesley"]
names.sorted(by: forwards(name1:name2:))
...
let sortedCollection2 = { (name1: String, name2: String) -> Bool in
    print(name1, name2)
...
names.sort(by: sortedCollection2)
